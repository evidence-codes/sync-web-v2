...
export default function UniquenessSection() {
  ...
  const features = [
    { text: "No Annual Fees.", icon: "🗎", custom: 0 },
    { text: "No Joining Fees.", icon: "💳", custom: 1 },
    { text: "No Rewards Redemption Fees.", icon: "🎁", custom: 2 },
    { text: "No Foreign Transaction Fees.", icon: "⚡", custom: 3 },
  ];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-20">
        ...
        <div className="relative w-full pt-0 md:pt-64 flex justify-center"> 
            ...
            <motion.div
                className="absolute hidden md:block p-6 rounded-xl bg-[#030C32] border border-white/10 shadow-2xl z-40 "
                style={{ top: '0', left: '0' }} 
                initial="hidden"
                whileInView="visible"
                ...
                viewport={{ once: true, amount: 0.5 }}
            >
                <h3 className="text-xl font-bold text-white mb-2 lg:bg-red-400">
            ...
            >
                <h3 className="text-xl font-bold text-white mb-2">
                    <span className="inline-block mr-2 text-[#113CFC]">💳</span> No Joining Fees.
                </h3>
            </motion.div>
            ...
            >
                <h3 className="text-xl font-bold text-white mb-2">
                    <span className="inline-block mr-2 text-[#113CFC]">🎁</span> No Rewards Redemption Fees.
                </h3>
            </motion.div>
        </div>
      </div>
